function night() {
	...
	function f() {
		this.reset = function() {
			...
			if (s.beginPath(), this.giant) s.fillStyle = "rgba(226,225,224," + this.opacity + ")", s.arc(this.x, this.y, 2, 0, 2 * Math.PI, !1);
			else if (this.comet) {
	...
	d(), window.addEventListener("resize", d, !1),
		...
		function t() {
			"night" == document.getElementsByTagName("html")[0].getAttribute("data-night") && c(), window.requestAnimationFrame(t)
		}()
}
night();