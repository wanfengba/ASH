	...
	customElements.define(
		...
		class JoeAbtn extends HTMLElement {
			constructor() {
				...
				this.innerHTML = `
                    <a class="joe_abtn" style="background: ${this.options.color}; border-radius: ${this.options.radius}" href="${this.options.href}" rel="noopener noreferrer nofollow">
	...
	customElements.define(
		...
		class JoeAnote extends HTMLElement {
			constructor() {
				...
				this.innerHTML = `
					<a class="joe_anote ${this.options.type}" href="${this.options.href}" rel="noopener noreferrer nofollow">
			...
			constructor() {
				...
				this.innerHTML = `
					<span class="joe_cloud">
						...
						<a class="joe_cloud__btn" href="${this.options.url}" rel="noopener noreferrer nofollow">
