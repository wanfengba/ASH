<!--风格四文章内容-->
    <!--文章信息-->
    <div class="joe_detail four-post" data-cid="<?php echo $this->cid ?>" style="background-image:url('<?php echo _getThumbnails($this)[0] ?>');height: 350px;border-radius: .8rem .8rem 0 0;">
