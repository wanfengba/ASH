...
<div class="joe_comment">
  <h3 class="joe_comment__title">评论 <?php if ($this->allow('comment') && $this->options->ACommentStatus !== "off") : ?>(<?php $this->commentsNum(); ?>)<?php endif; ?></h3>
  ...
  <?php else : ?>
    <?php if ($this->allow('comment') && $this->options->ACommentStatus !== "off") : ?>
    ...
    <?php else : ?>
      <div class="joe_comment__close">
        ...
        <?php if ($this->options->ACommentStatus === "off") : ?>
