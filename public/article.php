  ...
  <?php if (!$this->hidden && $this->fields->video) : ?>
    <div class="joe_detail__article-video">
      <div class="play">
        ...
        <div class="box">
          <iframe allowfullscreen="true" data-player="<?php $this->options->ACustomPlayer ? $this->options->ACustomPlayer() : Helper::options()->themeUrl('library/player.php?url=') ?>"></iframe>
        </div>
      </div>
      <div class="episodes">
