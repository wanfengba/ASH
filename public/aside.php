...
<aside class="joe_aside">
  <section class="joe_aside__item author">
    <img width="100%" height="120" class="image lazyload" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="<?php $this->options->Aside_Author_Image() ?>" alt="博主栏壁纸" />
    <div class="user">
      <img width="75" height="75" class="avatar lazyload" src="<?php _getAvatarLazyload(); ?>" data-src="<?php $this->options->Aside_Author_Avatar ? $this->options->Aside_Author_Avatar() : _getAvatarByMail($this->authorId ? $this->author->mail : $this->user->mail) ?>" alt="博主头像" />
    ...
    <?php if ($this->options->Aside_Author_Nav !== "off") : ?>
      <ul class="list"><?php _getAsideAuthorNav() ?></ul>
    <?php endif; ?>
  </section>
  <?php if ($this->options->Aside_Timelife_Status === 'on') : ?>
  ...
  <?php endif; ?>
  <?php if ($this->options->ACustomAside) : ?>
    <section class="joe_aside__item"><?php $this->options->ACustomAside() ?></section>
  <?php endif; ?>

  <?php if ($this->options->Aside_History_Today === 'on') : ?>
    <?php
    $time = time();
  ...
  <?php if ($this->options->Aside_Hot_Num && $this->options->Aside_Hot_Num !== 'off') : ?>
    <section class="joe_aside__item hot">
      ...
      <?php $this->widget('Widget_Contents_Hot@Aside', 'pageSize=' . $this->options->Aside_Hot_Num)->to($item); ?>
  ...
  <?php endif; ?>
  <?php if ($this->options->Aside_Newreply_Status === 'on' && $this->options->ACommentStatus !== 'off') : ?>
  ...
  <?php endif; ?>
  <?php if ($this->options->Aside_Weather_Key) : ?>
    <section class="joe_aside__item weather" data-key="<?php $this->options->Aside_Weather_Key() ?>" data-style="<?php $this->options->Aside_Weather_Style() ?>">
      <div class="joe_aside__item-title">
        <svg class="icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" width="18" height="18">
  ...
  <?php endif; ?>
  <?php if ($this->options->ADContent) : ?>
    <a class="joe_aside__item advert" target="_blank" rel="noopener noreferrer nofollow" href="<?php echo explode("||", $this->options->ADContent)[1]; ?>" title="广告">
      <img class="lazyload" width="100%" src="<?php _getLazyload() ?>" data-src="<?php echo explode("||", $this->options->ADContent)[0]; ?>" alt="广告" />
      <span class="icon">广告</span>
    </a>
  <?php endif; ?>
  <?php if ($this->options->Aside_Flatterer === 'on') : ?>
