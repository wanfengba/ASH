...
<?php if ($this->options->Aframe_index === 'two') : ?>
  <link href="<?php _getAssets('assets/css/Aframe_index.css'); ?>" rel="stylesheet" />
<?php endif; ?>
<?php endif; ?>
...
<script src="<?php _getAssets('assets/js/ASH.universe.min.js'); ?>"></script>
<?php if ($this->options->Aside_3DTag === 'on') : ?>
...
<?php if ($this->options->ACursorEffects && $this->options->ACursorEffects !== 'off') : ?>
  <script src="<?php _getAssets('assets/cursor/' . $this->options->ACursorEffects); ?>" async></script>
<?php endif; ?>
