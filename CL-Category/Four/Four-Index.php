                ...
                <?php if ($this->fields->mode === "default" || !$this->fields->mode) : ?>
                  <article class="Four_list-item wow">
                    	<div class="post_cover left">
                    		<a href="<?php $this->permalink() ?>" title="<?php $this->title() ?>" rel="noopener noreferrer">
                    		    <img width="100%" height="100%" class="post_bg entered ls-is-cached lazyload" src="<?php _getLazyload() ?>" data-src="<?php echo _getThumbnails($this)[0] ?>" alt="<?php $this->title() ?>" />
                    		</a>
                    	</div>
                    	<div class="Four_list-info">
                    		<a class="article-title" href="<?php $this->permalink() ?>" title="<?php $this->title() ?>"><?php $this->title() ?></a>
                    		<div class="article-meta-wrap">
                    			<span class="post-meta-date">
                    				<time datetime="<?php $this->date('Y年m月d日'); ?>"><?php $this->date('Y年m月d日'); ?></time>
                    			</span>
                    			<span class="article-meta">
                    				<span class="article-meta-label"><?php $this->commentsNum('%d'); ?> 评论</span>
                    			</span>
                    			<span class="article-meta">
                    				<span class="article-meta-label"><?php _getViews($this) ?> 阅读</span>
                    			</span>
                    		</div>
                    		<div class="content"><?php _getAbstract($this) ?></div>
                    	</div>
                    </article>
